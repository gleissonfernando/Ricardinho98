  ...
  return <div className="space-y-5">
    ...
    <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_380px]">
      <Card><CardHeader><CardTitle>Configuração</CardTitle></CardHeader><CardContent className="grid gap-4 md:grid-cols-2">
        ...
        {type === "summons" ? <FivemResourceMultiSelect label="Cargos responsáveis IAB (acesso)" options={roles} values={settings.teamRoleIds ?? []} disabled={!canManage} onChange={(teamRoleIds) => patch({ teamRoleIds })} /> : null}
        {type === "summons" ? <FivemResourceMultiSelect label="Cargos IAB mencionados no ticket" options={roles} values={settings.teamMentionRoleIds ?? []} disabled={!canManage} onChange={(teamMentionRoleIds) => patch({ teamMentionRoleIds })} /> : null}
        {type === "summons" ? <FivemResourceMultiSelect label="Cargos responsáveis Conselho (acesso)" options={roles} values={settings.conselhoRoleIds ?? []} disabled={!canManage} onChange={(conselhoRoleIds) => patch({ conselhoRoleIds })} /> : null}
        {type === "summons" ? <FivemResourceMultiSelect label="Cargos Conselho mencionados no ticket" options={roles} values={settings.conselhoMentionRoleIds ?? []} disabled={!canManage} onChange={(conselhoMentionRoleIds) => patch({ conselhoMentionRoleIds })} /> : null}
        {type === "summons" ? <FivemResourceMultiSelect label="Cargos responsáveis High Command (acesso)" options={roles} values={settings.hcmdRoleIds ?? []} disabled={!canManage} onChange={(hcmdRoleIds) => patch({ hcmdRoleIds })} /> : null}
        {type === "summons" ? <FivemResourceMultiSelect label="Cargos High Command mencionados no ticket" options={roles} values={settings.hcmdMentionRoleIds ?? []} disabled={!canManage} onChange={(hcmdMentionRoleIds) => patch({ hcmdMentionRoleIds })} /> : null}
        {type === "summons" ? <FivemResourceMultiSelect label="Cargos responsáveis Comissário (acesso)" options={roles} values={settings.comissarioRoleIds ?? []} disabled={!canManage} onChange={(comissarioRoleIds) => patch({ comissarioRoleIds })} /> : null}
        {type === "summons" ? <FivemResourceMultiSelect label="Cargos Comissário mencionados no ticket" options={roles} values={settings.comissarioMentionRoleIds ?? []} disabled={!canManage} onChange={(comissarioMentionRoleIds) => patch({ comissarioMentionRoleIds })} /> : null}
