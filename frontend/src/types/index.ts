...
export type FivemActionStat = { actionId: string; actionName: string; actionType: FivemActionType; type: FivemActionType; victories: number; defeats: number; total: number; winRate: number };
export type FivemActionDashboard = { settings: FivemActionSettings; actions: FivemActionDefinition[]; history: FivemActionSession[]; stats: FivemActionStat[] };
...
export type PoliceCoursesDashboard = { config: PoliceCourseConfig; courses: PoliceCourse[]; logs: Array<{ id: string; action: string; actorId: string | null; courseId: string | null; createdAt: string }> };
