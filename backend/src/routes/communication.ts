...
const summonsSettingsSchema = z.object({
  ...
  teamMentionRoleIds: z.array(snowflake).max(50).optional(), conselhoRoleIds: z.array(snowflake).max(50).optional(),
  conselhoMentionRoleIds: z.array(snowflake).max(50).optional(), hcmdRoleIds: z.array(snowflake).max(50).optional(),
  hcmdMentionRoleIds: z.array(snowflake).max(50).optional(), comissarioRoleIds: z.array(snowflake).max(50).optional(),
  comissarioMentionRoleIds: z.array(snowflake).max(50).optional(), allowedCommandRoleIds: z.array(snowflake).max(50).optional(),
